...
## act 4.
we want to generate a .pdf report for each district, but that takes time. let's use remote chunking so that the work could be divided across a number of worker nodes. we'll bring in my easy-spring-batch-remotechunking library
